  ...
  describe("Default user", () => {
    ...
    test("With nonexistent session", async () => {
      const nonexistentToken =
        "rWk7d5I4QKnsWRkJfYH0aDQgohHlJiY34BYC3nRb5zqddtIRPrljSpJ6a9vQ0B7JNCEpsQous0QfTBDPwAFb3pvFmTPLG";
    ...
    test("With almost expired session", async () => {
      ...
      jest.useFakeTimers({
        now: new Date(
          Date.now() - session.EXPIRATION_IN_MILLISECONDS + ONE_DAY_IN_MS,
        ),
      });
